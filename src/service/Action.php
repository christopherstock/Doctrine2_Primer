...
class Service_Action
{
    ...
    const ACTION_5_FIND_PRODUCT_BY_NAME = 7;
    const ACTION_6_FIND_ALL_PRODUCTS = 8;
    ...
    public static function perform($id)
    {
        switch ($id) {
            ...
            case self::ACTION_5_FIND_PRODUCT_BY_NAME:
                Example_Product::findByName();
                break;

            case self::ACTION_6_FIND_ALL_PRODUCTS:
    ...
    private static function showMainMenu()
    {
        ...
        Service_Console::log('<a href="?action=' . self::ACTION_5_FIND_PRODUCT_BY_NAME       . '">5. Find Product by name</a>');
        Service_Console::log('<a href="?action=' . self::ACTION_6_FIND_ALL_PRODUCTS          . '">6. Find all Products</a>');
        Service_Console::log();
